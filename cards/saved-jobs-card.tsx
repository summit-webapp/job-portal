...
const SavedJobsCard = ({ isLoading, data, error }: ProfileInterface) => {
      ...
      <div className="row">
        ...
        {data?.map((job: any, index: any) => {
          return (
            ...
            >
              <div className="pt-9 px-xl-9 px-lg-7 px-7 pb-7 card-body light-mode-texts bg-white rounded hover-shadow-3">
